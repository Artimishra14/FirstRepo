(function() {
    ...
    handwriting.recognize = function(trace, options, callback) {
        ...
        xhr.open("POST", "https://www.google.com.tw/inputtools/request?ime=handwriting&app=mobilesearch&cs=1&oe=UTF-8");//ye API call ho rha h aacha
        xhr.setRequestHeader("content-type", "application/json");
        xhr.send(data);
        // smjh to aya nahi hoga but ye aise kaam kr rha h
        // wo 4 line jo maine waha banaye h
        // unke x aur y coordinates ko save krke
        // ye API ko de dete h
        // model smjh jata h kya likha h aur prediction return krta h api kaam kasie krta h 
        // api ek tarah se bana hua program h jo ki google ke paas h
        // hn to uska jo online model h usko api se data jata h ye (x,y) coordinates ka
        // input h ek tarah se ajo hmlog de rhe h aur api bana hua code
        // usko do wo answer de deta h 
        // login page bana rhe the syd hn
    };
})();
